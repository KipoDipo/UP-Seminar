...
От изброените неща, не изглежда все едно да е най-полезното нещо. До сега сме се справяли и без нея. В реалния свят, когато можем да избегнем динамична памет, го правим. Но това понякога не е много скалируемо.  
...
# Инициализация
Както казахме по-рано, не можем да създаваме променливи на динамичната памет. 
...
cout << *ptr; // BAD - Undefined behaviour, 'val' is out of scope and its memory was freed
```
