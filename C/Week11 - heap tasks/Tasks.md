...
> Тези задачи са основни, защото се намират в стандартната библиотека на С (`<string.h>`), както и в C++ (`<cstring>`)
...
2) Позволете на потребителя да изпълнява следните операции:  
    ...
    - `pwd`*: Показва всички компоненти на текущия път на отделни редове (използвайте функцията за разбиване на пътя).  
